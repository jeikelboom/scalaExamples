...
object TestData {
  ...
  object Personnel{
    ...
    val emp1: Employee = Employee("Anna Nas")
    val add1: Address = Address("Bakerstreet 12", "London")
    val add2: Address = Address("KaasMarkt 45", "Alkmaar")
    val add3: Address = Address("AchterStraat 16", "Alkmaar")
    val dep1: Department = Department("HRM")
    val dep2: Department = Department("Silly walks")
    val dep3: Department = Department("IT")
    val fnc1: Function = Function("Recruiter")
    val fnc2: Function = Function("Junior programmer")
    val fnc3: Function = Function("Recruiter")
  }
