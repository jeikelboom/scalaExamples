...
class Intervals2Test extends FlatSpec with Matchers {
  ...
  val t1 :ZonedDateTime = read("2011-04-01 00:00")
  val t2 :ZonedDateTime = read("2012-04-03 00:00")
  val t3 :ZonedDateTime = read("2013-04-05 00:00")
  val t4 :ZonedDateTime = read("2014-04-07 00:00")
